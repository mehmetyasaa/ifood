    ...
    return (
        <View style={styles.container}>
                ...
                <Card style={styles.restaurantCard}>
                    <View style={styles.restaurantHeader}>
                        ...
                        <View style={styles.restaurantInfo}>
                            <Text style={styles.restaurantName}>Hamburgueria</Text>
                            <Text style={styles.restaurantDetails}>Lanches • 30-40 min</Text>
                        </View>
                    ...
                    <View style={styles.promotionContainer}>
                        <Text style={styles.promotionText}>ENTREGA GRÁTIS</Text>
                    </View>
                </Card>
            ...
            <View style={styles.buttonContainer}>
                <Button
                    title={isLoading ? "Konum alınıyor..." : "Continuar"}
                    variant="primary"
                    size="large"
                    fullWidth
                    loading={isLoading}
